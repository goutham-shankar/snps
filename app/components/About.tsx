  ...
  return (
    <section id="about" className="py-16 md:py-20 bg-gray-50">
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        {/* Principal's Message - Redesigned with Larger Image */}
        <div className="bg-white rounded-3xl shadow-lg overflow-hidden mb-12 md:mb-16">
          <div className="grid lg:grid-cols-3 gap-0">
            {/* Principal Info - More Prominent */}
            <div className="lg:col-span-1 bg-linear-to-br from-[#af5f36] to-[#8b4a28] p-8 md:p-12 flex flex-col justify-center text-white">
              <div className="text-center">
                <div className="relative w-40 h-40 md:w-48 md:h-48 rounded-2xl mx-auto mb-6 overflow-hidden border-4 border-white shadow-2xl">
                  <img
                    src={`/PRINCI.jpg`}
                ...
                <h3 className="text-2xl md:text-3xl font-bold mb-3">{schoolInfo.principal.name}</h3>
                <p className="text-orange-200 text-lg mb-2">{schoolInfo.principal.title}</p>
                <div className="inline-flex items-center gap-2 bg-white/20 backdrop-blur-sm px-4 py-2 rounded-full">
                  ...
                  <span className="text-sm font-medium">SNPS</span>
                </div>
              </div>
            </div>
